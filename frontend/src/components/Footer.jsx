      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <motion.div variants={fadeUp}>
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Professional satellite DGPS and digital land surveying services with 10+ years of
              experience delivering accurate results.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            ...
            <ul className="space-y-2">
              {['About', 'Services', 'Equipment', 'Workflow', 'Contact'].map((item) => (
                <li key={item}>
                  <a
          ...
          <motion.div variants={fadeUp}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 text-white/50 text-sm">
                ...
                <span>23A KM Complex, Near Sub Registrar Office, Aval Poondurai - 638115</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            &copy; {new Date().getFullYear()} Sri Velan Surveying. All rights reserved.
          </p>
