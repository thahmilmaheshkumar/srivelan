    ...
    <section id="contact" className="section-padding relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {contactInfo.map((item, i) => (
                <motion.a
                  ...
                  variants={scaleIn}
                  whileHover={{ y: -3, boxShadow: '0 0 20px rgba(212,168,67,0.15)' }}
          ...
          {/* Map */}
          <motion.div variants={fadeUp} className="glass-strong rounded-3xl overflow-hidden h-[400px] lg:h-full min-h-[350px]">
            <iframe
              title="Sri Velan Office Location"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.5!2d77.6!3d11.0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTHCsDAwJzAwLjAiTiA3N8KwMzYnMDAuMCJF!5e0!3m2!1sen!2sin!4v1"
              width="100%"
              height="100%"
